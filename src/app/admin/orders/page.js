...
export default function AdminOrdersPage() {
    ...
    return (
        <>
                        ...
                        <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                            ...
                            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <table className="min-w-full w-full table-fixed text-sm border border-gray-200 border-collapse">
                                        <tbody className="divide-y divide-gray-200">
                                            <tr>
                                                <td className="p-2 text-gray-500 w-40">Order Number</td>
                                                <td className="p-2 font-medium text-gray-900">
                                                    {selectedOrder.orderNumber}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="p-2 text-gray-500">Razorpay Order ID</td>
                                                <td className="p-2 font-medium text-gray-900">
                                                    {selectedOrder.razorpayOrderId || '—'}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="p-2 text-gray-500">Shiprocket Order ID</td>
                                                <td className="p-2 font-medium text-gray-900">
            ...
            {notification && (
                <div className={`fixed top-8 right-8 z-[100] flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl border animate-in slide-in-from-top-5 duration-300 ${notification.type === 'success'
